...
const DICT = {
  en: {
    ...
    'car.view_agency_catalog': 'View agency catalog','car.specs':'Specifications','car.choose_dates':'Choose your dates',
    'car.start':'Start','car.end':'End','car.your_details':'Your details','car.name':'Name',
    'car.email_optional':'Email (optional)','car.phone_required':'Phone *','car.book':'Book',
    ...
    'acar.options':'Options','acar.price_day':'Price/day','acar.location':'Location','acar.photo':'Photo URL',
    'acar.description':'Description','acar.save':'Save car','select.city':'Select city…','select.fuel':'Select fuel…',
  },
  fr: {
    brand: 'Vilis',
    ...
    'car.view_agency_catalog': "Voir le catalogue de l'agence",'car.specs':'Caractéristiques','car.choose_dates':'Choisissez vos dates',
    'car.start':'Début','car.end':'Fin','car.your_details':'Vos coordonnées','car.name':'Nom',
    'car.email_optional':'Email (facultatif)','car.phone_required':'Téléphone *','car.book':'Réserver',
    ...
    'acar.options':'Options','acar.price_day':'Prix/jour','acar.location':'Ville','acar.photo':'URL de la photo',
    'acar.description':'Description','acar.save':'Enregistrer','select.city':'Choisir une ville…','select.fuel':'Choisir un carburant…',
  },
};
...
/* SAFE HOOK: if provider ever fails/mounts late, fall back to EN instead of throwing */
